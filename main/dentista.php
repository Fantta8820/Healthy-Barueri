...
$dentista = "dentista";
$selectMedicos = $connection->prepare("SELECT * FROM medico WHERE especialidade = :dentista");
$selectMedicos->bindParam("dentista", $dentista);
...
<body class="w-full min-h-screen bg-gray-100">
  ...
  <main class="flex flex-col justify-center w-full min-h-screen">
    <section class="flex flex-col items-center w-full">
      <h1 class='text-3xl sm:text-4xl text-center font-bold pt-24 px-8'>Agendar Consulta com os nossos Dentistas</h1>
      <main
    ...
    <section class="w-full flex flex-col items-center">
      ...
      $selectQuery->bindParam("especialidade", $dentista);
      $selectQuery->execute();
