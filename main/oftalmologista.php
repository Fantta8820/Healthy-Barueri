...
$oftal = "oftalmologista";
$selectMedicos = $connection->prepare("SELECT * FROM medico WHERE especialidade = :oftal");
$selectMedicos->bindParam("oftal", $oftal);
...
<body class="w-full min-h-screen bg-gray-100">
  ...
  <main class="flex flex-col justify-center w-full min-h-screen">
    ...
    <section class="w-full flex flex-col items-center">
      ...
      $selectQuery->bindParam("especialidade", $oftal);
      $selectQuery->execute();
