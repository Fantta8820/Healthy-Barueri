...
$selectMedicos = $connection->prepare("SELECT * FROM medico WHERE especialidade = :ortopedista");
$selectMedicos->bindParam("ortopedista", $ortopedista);
...
<body class="w-full min-h-screen bg-gray-100">
  ...
  <main class="flex flex-col justify-center w-full min-h-screen">
    <section class="flex flex-col items-center w-full">
      <h1 class='text-3xl sm:text-4xl text-center font-bold pt-24 px-8'>Agendar Consulta com os nossos Ortopedistas</h1>
      <main
    ...
    <section class="w-full flex flex-col items-center">
      ...
      $selectQuery->bindParam("especialidade", $ortopedista);
      $selectQuery->execute();
