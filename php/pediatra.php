  ...
  <main class="flex flex-col justify-center w-full min-h-screen">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
      if (isset($_POST['submit'])) {
        ...
        file_put_contents('appointments/pediatra.txt', $appointments, FILE_APPEND);
    ...
    <section class="w-full flex flex-col items-center">
      ...
      <?php
      if (file_exists('appointments/pediatra.txt')) {
        $appointments = file_get_contents('appointments/pediatra.txt');
